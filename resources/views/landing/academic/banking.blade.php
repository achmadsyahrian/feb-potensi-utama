            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="post-content">
                        ...
                        <p class="post-title">{{ __('partials/navbar.navbar.banking') }}</p>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-12">
                    <div class="post-details-content mb-100">
                        <h1 class="mb-30">{{ __('academy/banking.banking.purpose.title') }}</h1>
                        <h4 class="mb-30">{{ __('academy/banking.banking.purpose.subtitle_vision') }}</h4>
                        <p>{{ __('academy/banking.banking.purpose.description_vision') }}</p>

                        <h4 class="mb-30">{{ __('academy/banking.banking.purpose.subtitle_mission') }}</h4>
                        <table class="text-secondary mb-30" style="border-collapse: collapse; width: 100%;">
                            @foreach (trans('academy/banking.banking.purpose.description_mission') as $key => $mission)
                                <tr>
                    ...
                    <div class="post-details-content mb-100">
                        <h1 class="mb-30">{{__('academy/banking.banking.curriculum.title')}}</h1>
                        <div class="col-12 col-lg-12">
                            <div class="accordions mb-50" id="accordion" role="tablist" aria-multiselectable="true">
                                @foreach (trans('academy/banking.banking.curriculum.content') as $semester => $courses)
                            ...
                            <table style="width: 100%; border-collapse: collapse;">
                                <thead>
                                    <tr>
                                        <th style="border: 0 solid #ddd; padding: 8px; text-align: right;">{{__('academy/banking.banking.curriculum.total_credits')}}</th>
