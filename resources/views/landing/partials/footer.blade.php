<footer class="footer-area mt-30">
    ...
    <div class="footer-logo mb-100">
        <a href="#"><img src="{{asset('landing/assets/img/logo-img/logo-feb.png')}}" style="width: 350px; object-fit:contain;" alt="{{__('home.app_name')}}" title="{{__('home.app_name')}}"></a>
    </div>
    <!-- Footer Content -->
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="footer-content text-center">
                    ...
                    <div class="footer-social-info">
                        ...
                        <a href="https://www.tiktok.com/@official_upu" target="_blank" data-toggle="tooltip" data-placement="top" title="tiktok">
