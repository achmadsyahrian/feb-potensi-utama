        ...
        <div class="classy-nav-container breakpoint-off">
            ...
            <div class="container-fluid">
                ...
                <nav class="classy-navbar justify-content-between" id="newsboxNav">
                    ...
                    <!-- Nav brand -->
                    <a href="{{route('landing.home')}}" class="nav-brand"><img src="{{asset('landing/assets/img/logo-img/logo-feb.png')}}" alt="Logo {{__('home.app_name')}}" title="{{__('home.app_name')}}"></a>
                        ...
                        <div class="classynav">
                            <ul>
                                ...
                                <li><a href="#">{{__('partials/navbar.navbar.academy')}}</a>
                                    <ul class="dropdown">
                                        <li><a href="{{route('landing.academic.economy')}}">{{__('partials/navbar.navbar.economics')}}</a></li>
                                        <li><a href="{{route('landing.academic.banking')}}">{{__('partials/navbar.navbar.banking')}}</a></li>
                                        <li><a href="{{route('landing.academic.accounting')}}">{{__('partials/navbar.navbar.accounting')}}</a></li>
                                        <li><a href="{{route('landing.academic.management')}}">{{__('partials/navbar.navbar.management')}}</a></li>
                                    </ul>
                                </li>
                                <li>
